...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\backOfficeBundle\\Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'backOfficeBundle\\Entity');

$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'backOfficeBundle' => 'backOfficeBundle\\Entity']);
